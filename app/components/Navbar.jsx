        ...
        <div className="relative z-10 max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-col md:items-end gap-3 w-full md:w-auto">
             ...
             <div className="relative w-full md:w-96">
                ...
                />
                <button className="absolute right-2 top-2 bg-emerald-600 text-white p-1.5 rounded-full hover:bg-emerald-500 transition shadow-lg">
